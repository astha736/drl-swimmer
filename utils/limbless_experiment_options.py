...
class ExperimentConditions:
    ...
    def senstivity_sCaudal_ncCPG(
        ...
        s_caudl_senstivity_list= [RobotFeedbackSenstivity.COS, RobotFeedbackSenstivity.SIN, RobotFeedbackSenstivity.SIGNONE, RobotFeedbackSenstivity.NONPERIOD],
        robot_shape: RobotInitialShape = RobotInitialShape.PARALLEL,
        robot_pose: int = 0,
        friction: float =0.2,
        **kwargs,
    ...
    def tegotae_sCaudal_ncCPG(
        ...
        **kwargs,
        ...
        robot_shapes = [RobotInitialShape.PARALLEL] if robot_shapes is None else robot_shapes
    ...
    def rlExp_sCaudal_ncCPG(
        ...
        **kwargs,
        ...
        exp_name = 's{}_'.format(s_caudl_senstivity) + \
